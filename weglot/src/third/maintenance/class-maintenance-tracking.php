...
class Maintenance_Tracking implements Hooks_Interface_Weglot {
	...
	public function __construct() {
		$this->maintenance_active_services = weglot_get_service( Maintenance_Active::class );
	}
	...
	public function hooks() {
		...
		add_filter( 'weglot_register_url', array( $this, 'weglot_maintenance_register_url' ) );
	}
	 ...
	 * @since 6.1
	 */
	public function weglot_maintenance_register_url( $url ) {
		return add_query_arg( 'fpr', 'wp-maintenance', $url );
	}
